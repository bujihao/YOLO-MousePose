...
```
python train.py --data mouse_kpts.yaml --cfg YOLO-MousePose-T.yaml --adamW --batch-size 16 --img 640  --kpt-label --weights 'path to the pre-trained ckpts' --cache-images
